...
module.exports = (app: any) => {
    const { STRING, INTEGER, NOW, UUID, UUIDV4 } = app.Sequelize;
    const User = app.model.define('user',
    {
        id: { type: UUID, primaryKey: true, allowNull: false, defaultValue: UUIDV4, description: 'uuid' },
        selfid: { type: INTEGER , primaryKey: true, autoIncrement: true, description: '自增id' },
        ...
        email_active: { type: STRING(100), validate: { isEmail: true }, description: '邮箱是否被激活' },
